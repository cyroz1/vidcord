...
The browser runtime also uses `@ffmpeg/ffmpeg`, an MIT-licensed package from
that repository. Its notices and source are available
through the package distribution and repository.
