...
export default function App() {
    ...
    try {
      ...
      const items: BatchCompressItem[] = prepared.map((item, index) => ({
        ...
        opts: {
          ...
          source_pix_fmt: item.probe.pix_fmt ?? null,
          source_color_transfer: item.probe.color_transfer ?? null,
  ...
  const startCompress = useCallback(async () => {
    ...
    const outputPath = await compressVideo({
      ...
      source_pix_fmt: probeData.pix_fmt ?? null,
      source_color_transfer: probeData.color_transfer ?? null,
      vaapi_device: vaapiDevice,
      gif_mode: gifMode,
